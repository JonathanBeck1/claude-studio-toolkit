...
Briefing content for the `ether-onboard` ritual. Claude reads these sections aloud during steps 1, 5, and 6 of the ritual. Paraphrase naturally to match the user's experience level; do not skip sections.

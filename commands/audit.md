...
- **Plan docs / brain files / skills** — `.md` under `docs/`, `/brain/`, `.claude/skills/`. No automated audit — just sanity-check the writing matches studio voice.
...
- Markdown → spot-check tone against `brain/studio-standards.md`. Flag emoji usage, AI-listicle phrasing, multi-paragraph docstrings.
